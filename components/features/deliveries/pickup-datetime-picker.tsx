      ...
      <div className="relative">
        ...
        {openPanel === "date" ? (
          <div
            ...
            className="absolute left-0 top-full z-30 mt-2 w-[min(100vw-2rem,18rem)] rounded-2xl bg-surface-elevated p-4 shadow-md sm:w-72"
          >
      ...
      <div className="relative">
        ...
        {openPanel === "time" ? (
          <div
            ...
            className="absolute left-0 top-full z-30 mt-2 max-h-60 w-full overflow-y-auto rounded-2xl bg-surface-elevated py-1 shadow-md"
          >
            {timeSlots.length === 0 ? (
