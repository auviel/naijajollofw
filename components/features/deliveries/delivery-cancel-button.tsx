  ...
  return (
    <>
      ...
      {open ? (
        ...
        >
          <div className="w-full max-w-md rounded-lg border border-border bg-surface-elevated p-5 shadow-sm">
            ...
            <div className="mt-4 space-y-4">
              <div className="space-y-2">
                ...
                <select
                  ...
                  className="flex h-12 w-full rounded-md border border-border-strong bg-background px-4 text-base text-foreground"
                >
